...
define([
    ...
    ShareAdminUploadLinksView, NotificationsView, AccountView, TagsView, TaggedItemsView) {
    "use strict";
    ...
    var Router = Backbone.Router.extend({
        ...
        initialize: function() {
            ...
            this.taggedItemsView = new TaggedItemsView();
        ...
        showTags: function() {
            this.switchCurrentView(this.tagsView);
            this.tagsView.show();
            this.sideNavView.setCurTab('tags');
        },

        showTaggedItems: function(name) {
            this.switchCurrentView(this.taggedItemsView);
            this.taggedItemsView.show(name);
            this.sideNavView.setCurTab('tags');
        }
    });
